...
(function () {
  ...
  function render() {
    ...
    const d = b.dither = Object.assign(
      { enabled: false, from: '#c71f05', to: '#ffe60d', grain: 0.25, levels: 3, contrast: 1, opacity: 1 },
      b.dither || {});
    ...
    root.append(
      ...
      group('Dither Gradient Fill',
        ...
        h('p', { class: 'hint' }, 'Posterizes the footage inside the box, adds grain, and maps brightness through the two colors below. Overrides solid/gradient fill when on.'),
        colorRow('Shadow color (dark)', d.from, (v) => { d.from = v; changed(); }),
        colorRow('Highlight color (bright)', d.to, (v) => { d.to = v; changed(); }),
